...
public class UserController {
    ...
    public CommonResponse getUserById(@Validated(UserDto.Update.class) @RequestBody UserDto userDto) {

        UserEntity userEntity = userService.getUserById(userDto.getId());
    ...
    public CommonResponse hasUserByName(@RequestParam String username) {
